...
| 手机网页状态页 | 状态总览 + 设备开关·场景·自动化·一键简报/自检 | `dsoul/webstatus.py` |
...
| 定时 / 条件自动化 | "每天22点提醒锁门"、"一进门就开灯" | `dsoul/triggers.py` |
