...
_XIE = {
    ...
    "飞蛾扑火": ("自取灭亡", "自己往绝路上撞。"),
    "水中捞月": ("一场空", "白费力气、得不到。"),
    "电线杆上绑鸡毛": ("好大的掸子", "讽刺好大的胆子（谐音）。"),
    "外甥打舅舅": ("公事公办", "不徇私情、照规矩来。"),
    "癞蛤蟆想吃天鹅肉": ("痴心妄想", "妄想得不可能的东西。"),
    "黄鼠狼单咬病鸭子": ("祸不单行", "倒霉的事偏赶一块儿。"),
    "搬起石头": ("砸自己的脚", "害人不成反害己。"),
    "竹篮子打水": ("一场空", "白忙一场。"),
    "千里送鹅毛礼轻": ("情意重", "礼薄情深。"),
    "丈二的灯台": ("照见人家，照不见自己", "只看见别人短处，看不见自己的。"),
    "包公断案": ("铁面无私", "公正不徇私。"),
    "韩信点兵": ("多多益善", "越多越好。"),
    "刘备借荆州": ("有借无还", "借了不还。"),
    "徐庶进曹营": ("一言不发", "始终不开口。"),
    "司马昭之心": ("路人皆知", "野心人人都看得出。"),
    "腊月里的萝卜": ("冻了心（动了心）", "心动了，谐音打趣。"),
}
