// 青鸾 · AI 短剧创作工坊 服务端入口（零依赖 Node 22+：node:sqlite / fetch / http）
...
try { process.loadEnvFile(path.join(ROOT, 'qingluan', '.env')); } catch { /* 可选的子应用独立配置 */ }
...
const PORT = Number(process.env.QINGLUAN_PORT) || 4399;
