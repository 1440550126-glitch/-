  ...
  switch (method) {
    case 'initialize':
      return reply({
        ...
        serverInfo: { name: 'qingluan-studio', title: '青鸾 · AI 短剧创作工坊', version: MCP_VERSION },
        instructions: '青鸾是开源 AI 短剧创作工坊。建议先 studio_overview 了解现状；流程：create_project → generate_script → parse_script → generate_storyboard_media(images→videos) → get_task 轮询。'
      });
    case 'ping':
      return reply({});
    case 'tools/list':
